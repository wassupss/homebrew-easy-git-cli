...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    "rollback.discardChanges": "🗑️  변경사항 취소 (작업 내용 버리기)",
    ...
    "rollback.noChangesToDiscard": "취소할 변경사항이 없습니다.",
    "rollback.changedFiles": "변경된 파일 목록",
    "rollback.selectDiscardOption": "어떤 변경사항을 취소하시겠습니까?",
    "rollback.discardAll": "모든 변경사항 취소 (Tracked + Untracked)",
    "rollback.discardTracked":
      "추적 중인 파일만 취소 (Modified/Deleted/Staged)",
    "rollback.discardSpecific": "특정 파일 선택",
    "rollback.selectFilesToDiscard":
      "취소할 파일을 선택하세요 (스페이스바로 선택):",
    "rollback.noFilesSelected": "선택된 파일이 없습니다.",
    "rollback.discardWarning":
      "선택한 파일의 변경사항이 영구적으로 삭제됩니다!",
    "rollback.filesCount": "파일 개수",
    "rollback.confirmDiscard": "정말로 변경사항을 취소하시겠습니까?",
    "rollback.discardSuccess": "변경사항이 취소되었습니다",
    "rollback.files": "파일",
    ...
    "custom.actionDiscard": "변경사항 취소 (discard)",
    "custom.actionMerge": "브랜치 병합 (merge)",
    "custom.actionFetch": "원격 정보 가져오기 (fetch)",
    "custom.actionCreateBranch": "브랜치 생성 (create branch)",
    "custom.actionDeleteBranch": "브랜치 삭제 (delete branch)",
    "custom.actionTag": "태그 생성 (create tag)",
    "custom.actionPR": "Pull Request 메뉴 열기",
    "custom.actionRollback": "Rollback 메뉴 열기",
    "custom.actionBranchManagement": "브랜치 관리 메뉴 열기",
    ...
    "custom.discardComplete": "변경사항 취소 완료",
    "custom.mergeComplete": "브랜치 병합 완료",
    "custom.fetchComplete": "원격 정보 가져오기 완료",
    "custom.branchCreated": "브랜치 생성됨",
    "custom.branchDeleted": "브랜치 삭제됨",
    "custom.tagCreated": "태그 생성됨",
    "custom.selectDiscardType": "취소할 변경사항 유형을 선택하세요:",
    "custom.discardAll": "모든 변경사항 취소",
    "custom.discardTracked": "추적 중인 파일만 취소",
    "custom.enterMergeBranch": "병합할 브랜치 이름을 입력하세요:",
    "custom.branchRequired": "브랜치 이름은 필수입니다.",
    "custom.useNoFf": "No Fast-Forward 병합을 사용하시겠습니까?",
    "custom.enterNewBranchName": "새 브랜치 이름을 입력하세요:",
    "custom.enterDeleteBranchName": "삭제할 브랜치 이름을 입력하세요:",
    "custom.forceDelete":
      "강제 삭제하시겠습니까? (병합되지 않은 변경사항 포함)",
    "custom.enterTagName": "태그 이름을 입력하세요:",
    "custom.tagRequired": "태그 이름은 필수입니다.",
    "custom.enterTagMessage": "태그 메시지를 입력하세요 (선택사항):",
  ...
  en: {
    ...
    "rollback.discardChanges": "🗑️  Discard Changes (Discard working changes)",
    ...
    "rollback.noChangesToDiscard": "No changes to discard.",
    "rollback.changedFiles": "Changed Files",
    "rollback.selectDiscardOption": "What changes would you like to discard?",
    "rollback.discardAll": "Discard all changes (Tracked + Untracked)",
    "rollback.discardTracked":
      "Discard tracked files only (Modified/Deleted/Staged)",
    "rollback.discardSpecific": "Select specific files",
    "rollback.selectFilesToDiscard": "Select files to discard (use spacebar):",
    "rollback.noFilesSelected": "No files selected.",
    "rollback.discardWarning":
      "Selected files' changes will be permanently deleted!",
    "rollback.filesCount": "File count",
    "rollback.confirmDiscard": "Are you sure you want to discard the changes?",
    "rollback.discardSuccess": "Changes have been discarded",
    ...
    "custom.actionDiscard": "Discard changes",
    "custom.actionMerge": "Merge branch",
    "custom.actionFetch": "Fetch remote info",
    "custom.actionCreateBranch": "Create branch",
    "custom.actionDeleteBranch": "Delete branch",
    "custom.actionTag": "Create tag",
    "custom.actionPR": "Open Pull Request menu",
    "custom.actionRollback": "Open Rollback menu",
    "custom.actionBranchManagement": "Open Branch Management menu",
    ...
    "custom.discardComplete": "Changes discarded",
    "custom.mergeComplete": "Merge complete",
    "custom.fetchComplete": "Fetch complete",
    "custom.branchCreated": "Branch created",
    "custom.branchDeleted": "Branch deleted",
    "custom.tagCreated": "Tag created",
    "custom.selectDiscardType": "Select type of changes to discard:",
    "custom.discardAll": "Discard all changes",
    "custom.discardTracked": "Discard tracked files only",
    "custom.enterMergeBranch": "Enter branch name to merge:",
    "custom.branchRequired": "Branch name is required.",
    "custom.useNoFf": "Use no fast-forward merge?",
    "custom.enterNewBranchName": "Enter new branch name:",
    "custom.enterDeleteBranchName": "Enter branch name to delete:",
    "custom.forceDelete": "Force delete? (includes unmerged changes)",
    "custom.enterTagName": "Enter tag name:",
    "custom.tagRequired": "Tag name is required.",
    "custom.enterTagMessage": "Enter tag message (optional):",
